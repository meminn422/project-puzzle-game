...
CLUE_INFO = {
    "老陳九點離開的說詞": {
        "scene"  : "書房",
        "source" : "與老陳對話，他聲稱九點就離開，但死者手錶停在十點十五分。",
        "meaning": "老陳的不在場說詞與死亡時間有明顯落差。",
        "hint"   : "搭配手錶上的死亡時間，能戳破老陳的謊言。",
    },
    "手錶停在十點十五分": {
        "scene"  : "書房",
        "source" : "在書桌上發現死者的手錶，停在十點十五分，錶殼上有掙扎刮痕。",
        "meaning": "死亡發生在十點十五分前後，不是老陳聲稱的九點之前。",
        "hint"   : "時間差確認後，老陳的不在場說詞就是謊言。",
    },
    "密函被人搶先拆開": {
        "scene"  : "書房",
        "source" : "對老陳出示破掉的信封後，老陳的驚慌反應透露信封被人搶先拆開。",
        "meaning": "這封原定寄給律師的密函，有人比律師更早看到內容。",
        "hint"   : "誰有辦公室的鑰匙，誰就能搶先進入取得這封信。",
    },
    "老陳持有辦公室鑰匙": {
        "scene"  : "書房",
        "source" : "老陳在追問後顫抖著交出二樓私人辦公室的鑰匙。",
        "meaning": "老陳一直持有辦公室鑰匙，有能力隨時進入。",
        "hint"   : "持有鑰匙的人才能進入辦公室接觸遺囑與密函。",
    },
    "酒中含強力鎮定劑": {
        "scene"  : "警局",
        "source" : "將打翻的紅酒杯交給鑑識凱文化驗，報告顯示酒中含高濃度強力鎮定劑。",
        "meaning": "死者是被人在酒中下藥，並非自然死亡或意外。",
        "hint"   : "藥物效果配合死者的掙扎痕跡，能還原死亡過程。",
    },
    "死前有劇烈掙扎痕跡": {
        "scene"  : "警局",
        "source" : "對法醫莎拉出示化驗報告，她指出死者手錶上有劇烈掙扎的刮痕。",
        "meaning": "死者在意識消失前曾試圖反抗，死亡並不平靜。",
        "hint"   : "掙扎意味著死者清醒時知道自己被害，藥物是讓他無力反抗的關鍵。",
    },
    "辦公室發現高跟鞋碎片": {
        "scene"  : "私人辦公室",
        "source" : "在辦公室沙發下發現高跟鞋碎片，是女性穿過的痕跡。",
        "meaning": "昨晚有女性穿著高跟鞋秘密進入這個上鎖的辦公室。",
        "hint"   : "府上哪位女性會在昨晚出現在辦公室？",
    },
    "遺囑將老陳除名": {
        "scene"  : "私人辦公室",
        "source" : "在辦公室發現老爺的原始遺囑，老陳的名字已被劃掉。",
        "meaning": "老爺打算將老陳從遺囑中除名，老陳因此失去三十年服務的報酬。",
        "hint"   : "三十年的忠誠，換來的是一張被修改過的紙。這是殺人的動機。",
    },
    "辦公室牆角有紅色碎片": {
        "scene"  : "私人辦公室",
        "source" : "在辦公室牆角發現紅色碎片，保險箱漆面被強行撬開留下的痕跡。",
        "meaning": "辦公室曾發生激烈的肢體衝突，保險箱遭人強行破壞。",
        "hint"   : "能進入這個上鎖辦公室的人，才可能在這裡留下衝突痕跡。",
    },
    "小美曾秘密進入辦公室": {
        "scene"  : "書房（對質）",
        "source" : "對小美出示高跟鞋碎片，她坦承昨晚曾秘密進入辦公室。",
        "meaning": "小美並非無辜的旁觀者，她有機會目擊辦公室發生的事。",
        "hint"   : "小美在辦公室時看到了什麼？繼續追問。",
    },
    "小美親眼目擊老陳下毒": {
        "scene"  : "書房（對質）",
        "source" : "小美在追問下坦承，她躲在沙發後親眼目擊老陳在酒中下藥。",
        "meaning": "這是直接指控老陳的目擊證詞，是破案的關鍵。",
        "hint"   : "有了目擊證詞，再拿出遺囑讓老陳無從抵賴。",
    },
    "老陳承認動機": {
        "scene"  : "書房（對質）",
        "source" : "對老陳出示原始遺囑後，他沉默承認自己因被除名而動機。",
        "meaning": "老陳服務三十年卻被遺囑除名，這是他殺人的根本原因。",
        "hint"   : "動機加上目擊證詞，足以在推理畫布上完成最終指控。",
    },
}